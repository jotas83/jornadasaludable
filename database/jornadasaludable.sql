...
-- 16 tablas: catálogos, dominio, sync, licencias y sobrecarga laboral.

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
SET time_zone = '+00:00';

DROP TABLE IF EXISTS `js_licencias`;
DROP TABLE IF EXISTS `js_sobrecarga_evaluaciones`;
DROP TABLE IF EXISTS `js_documentos`;
DROP TABLE IF EXISTS `js_derechos`;
DROP TABLE IF EXISTS `js_derechos_categorias`;
DROP TABLE IF EXISTS `js_alertas`;
DROP TABLE IF EXISTS `js_alertas_tipos`;
DROP TABLE IF EXISTS `js_horas_extra`;
DROP TABLE IF EXISTS `js_pausas`;
DROP TABLE IF EXISTS `js_fichajes`;
DROP TABLE IF EXISTS `js_jornadas`;
DROP TABLE IF EXISTS `js_contratos`;
DROP TABLE IF EXISTS `js_users`;
DROP TABLE IF EXISTS `js_centros_trabajo`;
...
CREATE TABLE `js_contratos` (
  ...
  CONSTRAINT `fk_contratos_user` FOREIGN KEY (`user_id`) REFERENCES `js_users` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `js_jornadas` (
  ...
  CONSTRAINT `fk_jornadas_user` FOREIGN KEY (`user_id`) REFERENCES `js_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_jornadas_contrato` FOREIGN KEY (`contrato_id`) REFERENCES `js_contratos` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `js_fichajes` (
  ...
  CONSTRAINT `fk_fichajes_jornada` FOREIGN KEY (`jornada_id`) REFERENCES `js_jornadas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_fichajes_user` FOREIGN KEY (`user_id`) REFERENCES `js_users` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `js_horas_extra` (
  ...
  CONSTRAINT `fk_horasextra_jornada` FOREIGN KEY (`jornada_id`) REFERENCES `js_jornadas` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `js_alertas` (
  ...
  CONSTRAINT `fk_alertas_user` FOREIGN KEY (`user_id`) REFERENCES `js_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_alertas_tipo` FOREIGN KEY (`tipo_id`) REFERENCES `js_alertas_tipos` (`id`) ON DELETE RESTRICT,
...
CREATE TABLE `js_sobrecarga_evaluaciones` (
  `id`                  INT UNSIGNED   NOT NULL AUTO_INCREMENT,
  `user_id`             INT UNSIGNED   NOT NULL,
  ...
  CONSTRAINT `fk_sobrecarga_user` FOREIGN KEY (`user_id`) REFERENCES `js_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `js_licencias` (
  ...
  CONSTRAINT `fk_licencias_empresa` FOREIGN KEY (`empresa_id`) REFERENCES `js_empresas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
VALUES
((SELECT id FROM js_derechos_categorias WHERE codigo='JORNADA'),
 'ART_34_ET',
...
(`categoria_id`, `codigo`, `titulo`, `referencia_legal`, `resumen`, `contenido_md`, `palabras_clave`, `idioma`, `version`, `vigente_desde`, `orden`, `publicado`)
VALUES
((SELECT id FROM js_derechos_categorias WHERE codigo='HORAS_EXTRA'),
 'ART_35_ET',
...
(`categoria_id`, `codigo`, `titulo`, `referencia_legal`, `resumen`, `contenido_md`, `palabras_clave`, `idioma`, `version`, `vigente_desde`, `orden`, `publicado`)
VALUES
((SELECT id FROM js_derechos_categorias WHERE codigo='DESCANSOS'),
 'ART_37_ET',
...
(`categoria_id`, `codigo`, `titulo`, `referencia_legal`, `resumen`, `contenido_md`, `palabras_clave`, `idioma`, `version`, `vigente_desde`, `orden`, `publicado`)
VALUES
((SELECT id FROM js_derechos_categorias WHERE codigo='REGISTRO'),
 'ART_12_RDL_8_2019',
